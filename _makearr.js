...
exports.makearr = exports.getHtml = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios["default"].get("https://www.ev.or.kr/portal/localInfo_motor");
...
var removeParenthesis = function removeParenthesis(str) {
  return str.replaceAll('(', '').replaceAll(')', '');
};

var parseSpace = function parseSpace(str) {
  return str.split(' ');
};
...
var makearr = function makearr(html) {
  var $ = _cheerio["default"].load(html.data);

  var $bodyList = $("table.table_02_2_1 tbody").children("tr");
  var ulList = [];
  $bodyList.each(function (i, elem) {
    // const mingan = parser($(this).find('td:nth-child(5)').text());
    // const chulgo = parser($(this).find('td:nth-child(7)').text());
    // const left = parser($(this).find('td:nth-child(8)').text());
    // const arr = ['전체','우선순위','법인','배달용','우선비대상'];
    ulList[i] = {
